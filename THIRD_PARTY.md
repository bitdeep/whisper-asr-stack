...
No upstream source tree, weights, customer audio or transcripts are copied into this repository. The serving image is fixed by digest in `engine.compose.yaml`.
